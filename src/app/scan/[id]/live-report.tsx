        ...
        <div className="flex flex-wrap items-start justify-between gap-4">
          ...
          <div className="flex w-full flex-shrink-0 flex-col gap-2 sm:w-auto">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className={`inline-flex items-center justify-center gap-2 rounded-xl px-5 transition-opacity hover:opacity-92 ${deckUrl ? "border py-2.5 text-xs font-semibold" : "py-3.5 text-sm font-bold"}`}
              style={deckUrl
