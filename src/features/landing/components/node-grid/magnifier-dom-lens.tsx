 ...
 * aligned so the point under the cursor stays centered. Sharp grid via non-smoothed mirror
 * blit + CSS crisp-edges.
 *
 * Ported from robot-components/app/nodegrid/_components/magnifier-dom-lens.tsx
 * Adapted: uses our CSS var names, no sound effects.
 */
export const MagnifierDomLens = ({
  mousePosRef,
  sourceCanvas,
  radius,
  zoom,
  children,
}: MagnifierDomLensProps) => {
  ...
  return (
    <div
      ...
      style={{
        ...
        pointerEvents: "none",
        zIndex: 50,
        /** Flat coin rim — no soft drop shadow or bright inset glow. */
        boxShadow:
          "inset 0 0 0 1px rgba(0,0,0,0.55), 0 0 0 1px rgba(140,140,145,0.95)",
      }}
    >
      <div
        ref={innerRef}
