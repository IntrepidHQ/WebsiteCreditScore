...
- Export/share/download actions are polished placeholders in v1.
- Preview images fall back to `public/previews/*` when a live website screenshot is unavailable.
